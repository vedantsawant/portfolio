    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="hero min-h-screen bg-base-200">
        <div className="hero-content flex-col lg:flex-row">
          <img
            src="https://i.pinimg.com/236x/9d/88/d6/9d88d6bcd3343d3780440dbd24505543.jpg"
            className="max-w-sm rounded-full shadow-2xl"
          />
          <div>
            <h1 className="text-5xl font-bold">Hi! I'm Vedant</h1>
            <p className="py-6">
              I am a graduate student in the MS Computer Science program at Stony Brook University. I'm currently interning as a Software Engineer at Electronic Arts
            </p>
